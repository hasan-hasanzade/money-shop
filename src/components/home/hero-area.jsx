...
const hero_content = {
  ...
  title: <><i><i className="child-1">Удобное</i> </i>{" "}
  <i><i className="child-1">платежное</i> </i>{" "}
  <i><i className="child-1">решение для</i> </i>{" "}
  <i><i className="child-1">вашего</i></i>
  <i><i className="child-1">бизнеса.</i></i>
  </>,
  btn_text: "Подключиться",
  sub_title: <>Более<span>40 тыс. платежей</span> в месяц</>,
    ...
    <>
      ...
      >
        ...
        <div className="tp-hero-2__mouse-scroll smooth d-none d-sm-block">
          <a className="mouse-scroll-btn"></a>
