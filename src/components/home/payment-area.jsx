...
const payment_content = {
    ...
    box_3_title: <>Принимайте оплату по СБП<br /> без карт и терминалов.</>,
                           ...
                           <div className="row">
                              <div className="col-md-6">
                                 <div className="tp-payment__content tp-payment__content-space">
                                    ...
                                    <ul className='tp-payment__list'>
                                        <li className='tp-payment__desc'>Мгновенные и удобные платежи для ваших клиентов.</li>
                                        <li className='tp-payment__desc'>Фиксация в USDT на следующий рабочий день.</li>
                                        <li className='tp-payment__desc'>Высокая конверсия в оплату.</li>
                                    </ul>
                                 </div>
                              </div>
                              <div className="col-md-6">
