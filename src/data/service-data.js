...
const  service_data = [
    // for home 01 
    {
        ...
        icon: img_1,
        img: img_1,
        title: "Согласование работы за 24 часа",
    ...
    },
    {
        ...
        icon: img_2,
        img: img_2,
        title: "Обслуживание первичного и вторичного трафика",
        description: <>Lorem Ipsum is simply dummy text <br /> of the printing</>,
        delay: ".6s",
    },
    {
        ...
        icon: img_3,
        img: img_3,
        title: "Дружественное API для интеграции",
        description: <>Lorem Ipsum is simply dummy text <br /> of the printing</>,
        delay: ".7s",
    },
    {
        ...
        icon: img_4,
        img: img_4,
        title: "Высокая отзывчивость к вашим пожеланиям",
        description: <>Lorem Ipsum is simply dummy text <br /> of the printing</>,
        delay: ".8s",
    },
    {
