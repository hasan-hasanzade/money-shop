...
const contact_content  = {
    ...
    tilte: <>Оставить заявку на подключение</>,
    info: <>или вопрос который вас интересует</> ,
     
}
const {tilte, info}  =  contact_content


const ContactFormArea = () => {
    return (
        <>
            <div id='contact' className="contact-form-area pb-120 pt-120">
